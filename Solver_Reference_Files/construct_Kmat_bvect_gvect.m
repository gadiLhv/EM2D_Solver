function [K,b] = construct_Kmat_bvect_gvect(nodeList,elementList,segmentList,ax,ay,beta,gammas,qs)
...
% bs(2,:) = [bs(2,2:end) bs(2,1)];

gs = zeros(size(bs));
for i = 1:2
    g(i,:) = bs(2,:) + [bs(1,2:end) bs(2,1)] - ...
        (ks(1,1)
end
